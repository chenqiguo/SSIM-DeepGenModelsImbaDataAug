...
@click.option('--target', 'target_fname', help='Target image file to project to', default='datasets/Birds/210/210_1fa820e481f4a3e34e40fca2dc303018.jpg', required=True, metavar='FILE')
...
@click.option('--outdir',                 help='Where to save the output images', default='results/project/Birds', required=True, metavar='DIR')
@click.option('--c',                      help='Class label', type=int, default=0, show_default=True) # newly added by Chenqi
