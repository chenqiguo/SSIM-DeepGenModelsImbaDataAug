...
python compute_ssim_metrics.py --all-pairs \
 ...
 --out results/CIFAR100_coarse_ssim.txt 
...
python compute_ssim_metrics.py \
...
python compute_ssim_metrics.py --all-pairs \
 ...
 --root /home/ps/scratch/KD_imbalance/BalancedKnowledgeDistillation/data/cifar-100-python/clean_img \
 --out results/CIFAR100imb100_coarse_ssim.txt 
...
python compute_ssim_metrics.py \
 ...
 --out results/ImageNet_coarse_ssim.txt 
...
python compute_ssim_metrics.py \
 ...
 --root /home/ps/scratch/KD_imbalance/LFME/my_data/ILSVRC/Data/CLS-LOC \
 --out results/ImageNet-LT_coarse_ssim.txt 
...
python compute_ssim_metrics.py \
 ...
 --out results/VOC_coarse_ssim.txt 
...
python compute_ssim_metrics.py \
 ...
 --out results/Adience_coarse_ssim.txt
...
python compute_ssim_metrics.py --all-pairs \
 ...
 --out results/flowers_coarse_ssim.txt
...
python compute_ssim_metrics.py \
 ...
 --out results/scene_coarse_ssim.txt
...
python compute_ssim_metrics.py \
 ...
 --out results/Birds_coarse_ssim.txt 
...
python compute_ssim_metrics.py \
 ...
 --root /home/ps/scratch/SSIM-DeepGenModelsImbaDataAug/data/inaturalist-2019 \
 --out results/Insects_coarse_ssim.txt 
