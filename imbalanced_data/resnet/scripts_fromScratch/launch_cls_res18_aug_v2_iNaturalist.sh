...
python cls_res.py -a resnet18 --gpu 1 --epochs 100 \
 --data /eecf/cbcsl/data100b/Chenqi/imbalanced_data/resnet/aug_data_v2/iNaturalist_eachSubCls/Insects \
 --result /eecf/cbcsl/data100b/Chenqi/imbalanced_data/resnet/results_fromScratch/iNaturalist_eachSubCls/cls_res18_gan_v2_iNaturalist/Insects
