...
python cls_res.py -a resnet18 --gpu 1 --epochs 100 \
 --data /eecf/cbcsl/data100b/Chenqi/imbalanced_data/resnet/aug_data/iNaturalist_eachSubCls/Insects \
 --result /eecf/cbcsl/data100b/Chenqi/imbalanced_data/resnet/results_fromScratch/cls_res18_gan_iNaturalist/Insects
...
python cls_res.py -a resnet18 --gpu 1 --epochs 100 \
 --data /eecf/cbcsl/data100b/Chenqi/imbalanced_data/resnet/aug_data/iNaturalist_eachSubCls/Fungi \
 --result /eecf/cbcsl/data100b/Chenqi/imbalanced_data/resnet/results_fromScratch/cls_res18_gan_iNaturalist/Fungi
...
python cls_res.py -a resnet18 --gpu 0 --epochs 100 -b 128 --saveEveryEpoch 5 \
 ...
 --resume /eecf/cbcsl/data100b/Chenqi/imbalanced_data/resnet/results_fromScratch/iNaturalist_allSuperCls/cls_res18_gan_iNaturalist/part4/checkpoint_Epoch80.pth.tar
