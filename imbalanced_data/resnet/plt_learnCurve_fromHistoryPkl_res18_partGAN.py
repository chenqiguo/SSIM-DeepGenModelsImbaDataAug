...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb  3 19:35:28 2022
...
gan_prefix = 'cls_res18_cGAN_' #'cls_res18_gan_v3'

folder_suff_orig = 'iNaturalist/Amphibians/'
folder_suff_gan = 'iNaturalist/Amphibians/opt2/step2/thresh_30/' #'cls_iNaturalist/Amphibians/step1_v2/thresh_12/'

pklFile = 'history.pkl'

model_arch = 'eachSubCls_cGAN_opt2_s2t30_' #'eachSubCls_v3cls_'
...
if __name__ == '__main__':
    ...
    gan_folder = srcRootDir + gan_prefix + folder_suff_gan
    ...
    model_type = model_arch + folder_suff_orig.split('/')[0] + '_' + folder_suff_orig.split('/')[1]
    ...
    print('np.argmax(valid_acc1_list_gan)=' + str(np.argmax(valid_acc1_list_gan)))
