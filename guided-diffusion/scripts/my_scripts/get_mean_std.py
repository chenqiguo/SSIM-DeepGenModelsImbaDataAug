...
if __name__ == "__main__":
    ...
    data_dir = '/eecf/cbcsl/data100b/Chenqi/guided-diffusion/datasets/my_data/for_resnet/Amphibians/step1/thresh_10/train/' #'/eecf/cbcsl/data100b/Chenqi/imbalanced_data/resnet/aug_data_cGAN/UTKFace/opt2/step2/thresh_25/train/' #'/eecf/cbcsl/data100b/Chenqi/transitional-cGAN/datasets/flowers/'
    batch_size = 256
